...
function Print_Text_Form_Element($obj_var, $instance, $element_name, $Text_Prompt){
...
function Print_CheckBox_Form_Element($Text_Prompt,$element_name, $select_items_list, $obj_var, $instance,$class_style=""){
...
function Print_Select_Form_Element($Text_Prompt,$field_name, $select_items_list, $obj_var, $instance,$class_style=""){
...
function print_select_list($selected_value,$buffer_select){
